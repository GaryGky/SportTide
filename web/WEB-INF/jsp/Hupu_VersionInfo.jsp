                                ...
                                <div class="col-sm-12">
                                    <div class="card-box table-responsive">
                                        ...
                                        <table id="datatable"
                                            ...
                                            <c:forEach var="info"
                                                       items="${sessionScope.versionInfo}">
                                                <tr>
                                                    <td>${info.getVersionCode()}</td>
                                                    <td>${info.getVersionName()}</td>
                                                    <td>${info.getUpdateUrl()}</td>
                                                    <td>${info.getUpdateInfo()}</td>

                                                    <td>
                                                        <button
                                                                onclick="delVersion(${info.getVersionCode()})"
...
<script type="text/javascript">
    window.onload = function () {
        $.get({
            url: "/Hupu-Admin/version/allVersion",
            data: {},
